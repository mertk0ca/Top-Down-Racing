...
public class carController : MonoBehaviour
{
    ...
    //driftmode 0.98
    //racingmode 0.35
    public float driftMode = 0.95f;
    public float accelerationConst = 30f;
    public float turnConst= 3.5f; 
    ...
    void ApplyEngineForce()
    {
        ...
        if(accelerationInput == 0)
            carRigidbody2D.drag = Mathf. Lerp(carRigidbody2D.drag, 0.01f, Time.fixedDeltaTime * 3);
